defmodule SurfaceApp.Accounts do
  @moduledoc """
  ...
  alias SurfaceApp.Accounts.{User, UserToken, UserStats, UserNotifier}
  ...
  def get_storeable_user!(id), do: Repo.get!(User, id) |> User.to_storeable_map()
  ...
  def deliver_user_confirmation_instructions(%User{} = user, confirmation_url_fun)
      when is_function(confirmation_url_fun, 1) do
        UserStats.add_stats_record(user)
