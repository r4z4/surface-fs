defmodule SurfaceApp.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    field :user_follows, {:array, :integer}
    field :user_post_likes, {:array, :integer}
  ...
  # def user_post_like_changeset(user, attrs, opts \\ []) do
  #   user
  #   |> cast(attrs, [:user_post_likes])
  # end
  ...
  """
  def valid_password?(%SurfaceApp.Accounts.User{hashed_password: hashed_password}, password)
