defmodule SurfaceAppWeb.Components.ChatMessages do
  @moduledoc """
  ChatMessages component
  """
  use Surface.LiveComponent
  alias Surface.Components.Form
  alias Surface.Components.Form.{TextInput, Label}
  ...
  data room_id, :integer
  data id, :integer
  data current_user, :string
  data room, :string
  ...
  #   base_url = VideoChatWeb.Endpoint.url()
  #   link = base_url <> Routes.live_path(socket, VideoChatWeb.Live.JoinRoomView, code)
